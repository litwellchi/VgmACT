...
run_id=V3_DiTB_future4_dynamicvidloss_full_fix900_rt1pretrain #_${time}
...
CUDA_VISIBLE_DEVICES=2,3,4,5,6,7 /aifs4su/mmcode/videogen/anaconda3/envs/simpler_env/bin/torchrun --standalone --nnodes 1 --nproc-per-node $num_cards scripts/train_vgmvla.py \
  ...
  --full_ckpt "/aifs4su/mmcode/worldm/videoact/VgmACT/V3_DiTB_freeze_fix900_rt1pretrain--image_aug/checkpoints/step-018000-epoch-600-loss=0.0021.pt"
