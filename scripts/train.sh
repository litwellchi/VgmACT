...
CUDA_VISIBLE_DEVICES=1 /aifs4su/mmcode/videogen/anaconda3/envs/simpler_env/bin/torchrun --standalone --nnodes 1 --nproc-per-node $num_cards scripts/train.py \
  ...
  --is_resume False \
  --pretrained_checkpoint "/aifs4su/mmcode/worldm/CogACT/CogACT/CogACT-Base/checkpoints/CogACT-Base.pt" 
